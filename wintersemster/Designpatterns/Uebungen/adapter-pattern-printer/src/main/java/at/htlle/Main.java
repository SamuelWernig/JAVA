...
public class Main {
    public static void main(String[] args) {
        ...
        String path = "C:\\Users\\samue\\Desktop\\JAVA_PROJECTS\\JAVA\\wintersemster\\Designpatterns\\Uebungen";
        FileWriterLegacy fileWriter = new FileWriterLegacy();
        Printer printer = new FileWriterAdapter(fileWriter, path); // ersetzen
